...
wget --no-check-cert 'https://dl.dropboxusercontent.com/u/81527571/Debian%207%20(64%20bit)/Keyboard_settings.conf'
...
sed -i "s/$vncPort = 5900/$vncPort = $vncport - 1/g" /usr/local/bin/vncserver
sed -i "s/sockaddr_in(5900/sockaddr_in($vncport - 1/g" /usr/local/bin/vncserver
sudo wget --no-check-cert 'https://dl.dropboxusercontent.com/u/81527571/Debian%207%20(64%20Bit)/xstartup.txt?dl=1'
sudo mv xstartup.txt?dl=1 /etc/init.d/xstartup
sudo wget --no-check-cert 'https://dl.dropboxusercontent.com/u/81527571/Debian%207%20(64%20Bit)/tightvncserver.txt?dl=1'
