...
wget --no-check-cert 'https://dl.dropboxusercontent.com/u/81527571/Debian%208%20(64%20Bit)/Keyboard_settings.conf'
...
su  - $name -c "vncserver -kill :1"
cd /usr/local/bin/
wget --no-check-cert 'https://dl.dropboxusercontent.com/u/81527571/Debian%208%20(64%20Bit)/myvncserver'
sudo chown $name myvncserver
sudo chmod +x /usr/local/bin/myvncserver
cd /lib/systemd/system/
wget --no-check-cert 'https://dl.dropboxusercontent.com/u/81527571/Debian%208%20(64%20Bit)/myvncserver.service'
