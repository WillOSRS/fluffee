...
wget --no-check-cert 'https://bitbucket.org/teamfluffee/fluffees-server-setup/raw/master/Debian/Debian-8/Keyboard_settings.conf' &> /dev/null
...
su  - $name -c "vncserver -kill :1" &> /dev/null
cd /usr/local/bin/
wget --no-check-cert 'https://bitbucket.org/teamfluffee/fluffees-server-setup/raw/master/Debian/Debian-8/myvncserver' &> /dev/null
sudo chown $name myvncserver &> /dev/null
sudo chmod +x /usr/local/bin/myvncserver &> /dev/null
cd /lib/systemd/system/
wget --no-check-cert 'https://bitbucket.org/teamfluffee/fluffees-server-setup/raw/master/Debian/Debian-8/myvncserver.service' &> /dev/null
