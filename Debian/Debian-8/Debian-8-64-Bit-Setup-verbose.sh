...
apt-get -y install sudo wget nano locales debconf-utils xauth xfonts-base dialog libxslt1.1 netselect-apt x11-xkb-utils
...
apt-get install -yq libjpeg62-turbo-dev zlib1g-dev build-essential xutils-dev
